...
send_command('wait 1; input /macro book 11; wait 1; input /macro set 1; wait 1; input /echo .       ==> DNC Gearswap Loaded, Macro Book 11, Set 1 equipped, all slots changeable...') -- ''; wait 1; input /lockstyleset 11'
equip(sets.gear)